...
export const RoleGuard4 : CanActivateFn = (route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Promise <boolean | UrlTree> =>{
    return inject(RoleGuards4).canActivate(route,state);
}
